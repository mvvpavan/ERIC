...
<head>
  ...
  <style type="text/css">
    ...
    h1 {text-align: center; font-size: 2.8em; color: #edece8; margin-bottom: 3px; text-shadow: 0 1px 0px rgba(0,0,0, .2)}
    h1 .small {text-align: center; font-size: 0.3em; font-weight:lighter; color: #444;}
